...
// Two-word commands (`git commit`, `h0x terminal`) must keep their second word in Latin.
...
export const JA_PHRASE_FIXES = [
  ...
  { pattern: /崩壊させる/g, replacement: '折りたたむ', whenEnIncludes: 'Collapse h0x-ADE' },
  ...
  { pattern: /再起動します/g, replacement: '再起動', whenEnIncludes: 'Restart h0x-ADE' },
  ...
  // h0x-ADE's host covers SSH hosts and this computer; skipped where the English also says server.
  {
