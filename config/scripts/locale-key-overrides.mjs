...
const BASE_LOCALE_KEY_OVERRIDES = {
  ...
  'menu.showMobileButton': {
    ko: 'h0x-ADE 모바일 버튼 표시',
    zh: '显示 h0x-ADE Mobile 按钮',
    ja: 'h0x-ADE Mobile ボタンを表示'
  },
  ...
  'menu.exploreOrca': { ko: 'h0x-ADE 둘러보기', zh: '探索 h0x-ADE', ja: 'h0x-ADE を探索' },
  ...
  // Onboarding pill beside h0x-ADE Mobile: "New" marks a new feature, not a create action.
