...
export const KO_VALUE_OVERRIDES = {
  ...
  'h0x-ADE uses the GitHub CLI (gh) to show pull requests, issues, and checks.':
    'h0x-ADE는 GitHub CLI(gh)를 사용하여 PR, 이슈 및 검사를 표시합니다.',
  ...
  'CLI skill': 'CLI 스킬',
  'h0x-ADE CLI skill': 'h0x-ADE CLI 스킬',
  ...
  'Review inactive workspaces before deleting their local files and h0x-ADE state.':
    '로컬 파일과 h0x-ADE 상태를 삭제하기 전에 비활성 워크스페이스를 확인하세요.',
  ...
  'check #': '체크 #',
  'to submit.': '제출.',
  'Install the h0x-ADE skill so agents know to use the h0x-ADE CLI.':
    '에이전트가 h0x-ADE CLI를 사용하도록 h0x-ADE 스킬을 설치하세요.',
  ...
  "Control h0x-ADE from your phone. Check on agents, review changes, and kick off tasks while you're away from your desk.":
    '휴대폰에서 h0x-ADE를 제어하세요. 자리를 비운 동안 에이전트를 확인하고, 변경 사항을 리뷰하고, 작업을 시작하세요.',
