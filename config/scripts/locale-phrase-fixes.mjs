...
export const LOCALE_PHRASE_FIXES = {
  ...
  zh: [
    ...
    {
      pattern: /连接到h0x-ADE/g,
      replacement: '连接到 h0x-ADE',
      whenEnIncludes: 'Connect to h0x-ADE'
    },
    {
      pattern: /开始使用h0x-ADE/g,
      replacement: '开始使用 h0x-ADE',
      whenEnIncludes: 'get started with h0x-ADE'
    },
