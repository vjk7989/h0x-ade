...
export const LOCALE_VALUE_OVERRIDES = {
  es: {
    'Explore h0x-ADE': 'Explorar h0x-ADE',
  ...
  ko: {
    ...
    'Connect to h0x-ADE': 'h0x-ADE에 연결',
    'USB Devices': 'USB 장치',
  ...
  zh: {
    ...
    'Connect to h0x-ADE': '连接到 h0x-ADE',
    'USB Devices': 'USB 设备',
  ...
  ja: {
    ...
    'Connect to h0x-ADE': 'h0x-ADE に接続',
    ...
    'Kill all': 'すべて強制終了',
    'kill all': 'すべて終了',
    'Collapse h0x-ADE': 'h0x-ADE を折りたたむ',
