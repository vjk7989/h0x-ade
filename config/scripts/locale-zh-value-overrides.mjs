...
export const ZH_VALUE_OVERRIDES = {
  ...
  'h0x-ADE IDE': 'h0x-ADE IDE',
  'h0x-ADE first': 'h0x-ADE 优先',
  'h0x-ADE Mobile': 'h0x-ADE Mobile',
  'h0x-ADE logo': 'h0x-ADE 标志',
  'Enjoying h0x-ADE?': '喜欢 h0x-ADE 吗？',
  'Get to know h0x-ADE': '了解 h0x-ADE',
  'Expand h0x-ADE': '展开 h0x-ADE',
  'Support h0x-ADE': '支持 h0x-ADE',
  'Restarting h0x-ADE…': '正在重启 h0x-ADE…',
  'Show h0x-ADE Mobile Button': '显示 h0x-ADE Mobile 按钮',
  ...
  "Give agents direct access to h0x-ADE's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 h0x-ADE 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from h0x-ADE. It is still on your disk.': '来自 h0x-ADE。它仍保留在您的磁盘上。',
