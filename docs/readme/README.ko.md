<h1 align="center">
  <a href="https://onOrca.dev"><img src="../../resources/build/icon.png" alt="h0x-ADE" width="64" valign="middle" /></a> h0x-ADE
</h1>

<p align="center">
  <a href="https://github.com/vjk7989/h0x-ade"><img src="https://img.shields.io/github/stars/vjk7989/h0x-ade?style=flat&amp;label=%E2%98%85&amp;color=08C" alt="GitHub 스타" /></a>
  <a href="https://github.com/vjk7989/h0x-ade/releases"><img src="../assets/readme-downloads.svg" alt="전체 릴리스 누적 다운로드 수" /></a>
  <img src="https://img.shields.io/badge/license-MIT-08C?style=flat" alt="라이선스: MIT" />
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="h0x-ADE Discord 참여" /></a>
  <a href="https://x.com/orca_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="X에서 h0x-ADE 팔로우" /></a>
...
<h3 align="center"><a href="https://onorca.dev/download"><ins>h0x-ADE 다운로드</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="병렬 worktree에서 에이전트를 실행 중인 h0x-ADE 데스크톱 앱과 한쪽 모서리에 보이는 h0x-ADE 모바일 companion 앱" width="960" />
</p>
...
[iOS App Store](https://apps.apple.com/us/app/orca-ide/id6766130217) · [TestFlight](https://testflight.apple.com/join/YjeGMQBA) · [Android APK 0.0.47](https://github.com/vjk7989/h0x-ade/releases/download/mobile-android-v0.0.47/app-release.apk) · [문서 →](https://www.onorca.dev/docs/mobile)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="h0x-ADE 데스크톱과 모바일 companion 앱" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="h0x-ADE의 GitHub 및 Linear 작업 워크플로" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
diff의 어느 줄에든 코멘트를 남기고 에이전트에게 바로 보내세요 — h0x-ADE를 떠나지 않고 리뷰하고 수정하고 커밋할 수 있습니다.
...
에이전트도 h0x-ADE를 조작할 수 있습니다 — `h0x worktree create`, `snapshot`, `click`, `fill`로 모든 워크플로를 스크립팅하세요.

[문서 →](https://www.onorca.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/cli/overview"><picture><source srcset="../assets/feature-wall/orca-cli.gif" type="image/gif"><img src="../assets/feature-wall/orca-cli.jpg" alt="CLI에서 h0x-ADE 스크립팅" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **그리고 훨씬 더 많은 기능** — 새로운 기능이 매일 출시되므로 이 목록은 늘 한 발 늦습니다. 진짜 기능은 [체인지로그](https://github.com/vjk7989/h0x-ade/releases)에서 확인하세요.

---

## 지원 에이전트

**모든 CLI 에이전트**와 함께 작동합니다 — 터미널에서 실행되는 에이전트라면 h0x-ADE에서도 실행됩니다.
...
- 또는 빌드를 직접 받기: [macOS Apple Silicon](https://github.com/vjk7989/h0x-ade/releases/latest/download/h0x-macos-arm64.dmg) · [macOS Intel](https://github.com/vjk7989/h0x-ade/releases/latest/download/h0x-macos-x64.dmg) · [Windows (.exe)](https://github.com/vjk7989/h0x-ade/releases/latest/download/h0x-windows-setup.exe) · [Linux AppImage](https://github.com/vjk7989/h0x-ade/releases/latest/download/h0x-linux.AppImage) · [전체 빌드](https://github.com/vjk7989/h0x-ade/releases/latest)
- headless Linux 서버에서 `h0x serve`를 실행하시나요? [Headless Linux 서버 가이드](../reference/headless-linux-server.md)를 확인하세요.
...
- **Android:** [APK 0.0.47 다운로드](https://github.com/vjk7989/h0x-ade/releases/download/mobile-android-v0.0.47/app-release.apk) · [설치 가이드](https://www.onorca.dev/docs/android-apk)
...
- **WeChat:** QR 코드를 스캔해 h0x-ADE 커뮤니티 WeChat 그룹 8에 참여하세요. 그룹 8이 가득 찼을 수 있으니, 그런 경우 그룹 9 QR 코드를 스캔하세요.

  <img src="../assets/wechat-qr-group8.jpg" alt="h0x-ADE 커뮤니티 WeChat 그룹 8 QR 코드" width="160" />&nbsp;&nbsp;<img src="../assets/wechat-qr-group9.jpg" alt="h0x-ADE 커뮤니티 WeChat 그룹 9 QR 코드" width="160" />

- **피드백과 아이디어:** 우리는 빠르게 출시합니다. 필요한 기능이 있나요? [새 기능을 요청](https://github.com/vjk7989/h0x-ade/issues)하세요.
- **개인정보 보호:** h0x-ADE가 수집하는 익명 사용 데이터와 수집 거부 방법은 [개인정보 및 텔레메트리 문서](https://www.onorca.dev/docs/telemetry)를 참고하세요.
- **응원하기:** 이 리포지토리에 [Star](https://github.com/vjk7989/h0x-ade)를 눌러 매일 공개되는 릴리스 소식을 확인해 주세요.
...
<a href="https://github.com/vjk7989/h0x-ade/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=stablyai/orca" alt="h0x-ADE 기여자" />
</a>
...
h0x-ADE는 [MIT 라이선스](../../LICENSE)에 따라 자유롭게 사용할 수 있는 오픈 소스입니다.
