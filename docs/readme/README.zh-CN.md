...
<p align="center">
  ...
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="加入 h0x-ADE Discord" /></a>
  <a href="https://x.com/orca_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="在 X 上关注 h0x-ADE" /></a>
...
<h3 align="center"><a href="https://onorca.dev/download"><ins>下载 h0x-ADE</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="h0x-ADE 桌面应用在并行 worktree 中运行智能体，角落里是 h0x-ADE 移动 companion 应用" width="960" />
</p>
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="h0x-ADE 桌面端与移动 companion 应用" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="h0x-ADE 中的 GitHub 与 Linear 任务工作流" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
在任意 diff 行上添加评论并发回给智能体 — 评审、编辑、提交，全程无需离开 h0x-ADE。
...
智能体也能驱动 h0x-ADE — 用 `h0x worktree create`、`snapshot`、`click` 和 `fill` 把每个工作流脚本化。

[文档 →](https://www.onorca.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/cli/overview"><picture><source srcset="../assets/feature-wall/orca-cli.gif" type="image/gif"><img src="../assets/feature-wall/orca-cli.jpg" alt="从 CLI 脚本化 h0x-ADE" width="100%" /></picture></a>
</td>
</tr>
</table>
...
适配**任何 CLI 智能体** — 只要能在终端里运行，就能在 h0x-ADE 里运行。
...
- **微信:** 扫码加入 h0x-ADE 社区微信第 8 群。第 8 群可能已满，如遇这种情况请扫描第 9 群二维码。

  <img src="../assets/wechat-qr-group8.jpg" alt="h0x-ADE 社区微信第 8 群二维码" width="160" />&nbsp;&nbsp;<img src="../assets/wechat-qr-group9.jpg" alt="h0x-ADE 社区微信第 9 群二维码" width="160" />

- **反馈与想法:** 我们发布很快。缺少什么功能？[提交功能请求](https://github.com/vjk7989/h0x-ade/issues)。
- **隐私:** 查看[隐私与遥测文档](https://www.onorca.dev/docs/telemetry)，了解 h0x-ADE 收集哪些匿名使用数据以及如何退出。
...
<a href="https://github.com/vjk7989/h0x-ade/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=stablyai/orca" alt="h0x-ADE 贡献者" />
</a>

## 许可证

h0x-ADE 是自由且开源的软件，遵循 [MIT 许可证](../../LICENSE)。
