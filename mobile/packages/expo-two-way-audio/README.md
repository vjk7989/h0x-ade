# h0x-ADE Two Way Audio

Vendored Expo module for capturing and playing PCM audio data in the h0x-ADE mobile app (iOS and Android).
...
Some audio features of expo-two-way-audio like Acoustic Echo Cancelling, noise reduction or microphone modes (iOS) don't work on simulator. Run the h0x-ADE mobile app on a real device to test these features.
