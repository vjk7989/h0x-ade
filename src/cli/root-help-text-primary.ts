export const ROOT_HELP_TEXT_PRIMARY = [
  ...
  '',
  'Startup:',
  '  open                      Launch h0x-ADE and wait for the runtime to be reachable',
  '  serve                     Start a headless h0x-ADE runtime server',
  '  status                    Show app/runtime/graph readiness',
  '',
  'Diagnostics:',
  '  diagnostics memory        Collect a memory snapshot for h0x-ADE and managed terminals',
  '',
  'Agent Discovery:',
  ...
  '  skills list               List version-matched skill guides bundled with this h0x CLI',
  '  skills get                Print a version-matched skill guide as Markdown',
  '  skills install            Install bundled h0x-ADE skills globally via the community skills CLI',
  '  skills update             Update already-installed h0x-ADE skills via the community skills CLI',
  '',
  'Hosts:',
  '  host list                 List targetable machines and how to name each one',
  '',
  'Environments:',
  '  environment add           Save a remote h0x-ADE runtime from a pairing code',
  '  environment list          List saved remote h0x-ADE runtimes',
  '  environment show          Show one saved remote h0x-ADE runtime',
  '  environment rm            Remove a saved remote h0x-ADE runtime',
  '',
  'Environment Recipes:',
  '  vm recipe doctor          Validate a per-workspace environment recipe',
  '',
  'Automations:',
  '  automations list          List scheduled h0x-ADE automations',
  '  automations show          Show one h0x-ADE automation',
  '  automations create        Create a scheduled h0x-ADE automation',
  '  automations edit          Edit an h0x-ADE automation',
  '  automations remove        Remove an h0x-ADE automation and its run history',
  '  automations run           Run an h0x-ADE automation now',
  '  automations runs          List automation run history',
  '',
  'Projects:',
  '  project list              List durable projects known to h0x-ADE',
  ...
  '',
  'Repos:',
  '  repo list                 List repos registered in h0x-ADE',
  '  repo add                  Add a project to h0x-ADE by filesystem path',
  ...
  '',
  'Worktrees:',
  '  worktree list             List h0x-ADE-managed worktrees',
  '  worktree show             Show one worktree',
  '  worktree current          Show the h0x-ADE-managed worktree for the current directory',
  '  worktree create           Create a new h0x-ADE-managed worktree',
  '  worktree set              Update h0x-ADE metadata for a worktree',
  '  worktree rm               Remove a worktree from h0x-ADE and git',
  '  worktree ps               Show a compact orchestration summary across worktrees',
  '',
  'Files:',
  '  file open                 Open a workspace file in the h0x-ADE editor',
  '  file diff                 Open a workspace file diff in the h0x-ADE editor',
  '  file open-changed         Open all git-changed files for a workspace',
  '',
  'Terminals:',
  '  terminal list             List live h0x-ADE-managed terminals',
  ...
  '  emulator list             List available/running emulators (h0x-ADE-managed + raw serve-sim)',
