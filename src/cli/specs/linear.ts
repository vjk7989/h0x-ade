...
export const LINEAR_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    examples: ['h0x linear search "auth bug"', 'h0x linear search ENG --workspace all --json']
  },
  {
    ...
    examples: ['h0x linear team list --workspace all --json']
  },
  {
    ...
    examples: ['h0x linear team members --team ENG --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'team', 'workspace'],
    examples: ['h0x linear team states --team ENG --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'team', 'workspace'],
    examples: ['h0x linear team labels --team ENG --json']
  },
  {
    ...
    examples: [
      ...
      'h0x linear project list --workspace all --json'
    ]
  },
  {
    path: ['linear', 'list'],
    ...
    examples: ['h0x linear list --filter assigned --limit 10 --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'h0x linear status set ENG-123 --to "In Review"',
      'h0x linear status set --current --to Done --json'
    ]
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['h0x linear assignee set --current --me --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['h0x linear assignee clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['h0x linear priority set --current --to high --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['h0x linear priority clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['h0x linear estimate set --current --to 3 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['h0x linear estimate clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['h0x linear due-date set --current --to 2026-06-30 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['h0x linear due-date clear ENG-123 --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['h0x linear label add --current --label Bug --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'label', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['h0x linear label remove --current --label Bug --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'label', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['h0x linear label set ENG-123 --label Bug --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'h0x linear comment add ENG-123 --body "Implementation is ready for review."',
  ...
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'h0x linear attach ENG-123 --url https://example.com/review/123 --title "PR/MR link"',
      'h0x linear attach --current --url https://example.com/review/123 --json'
    ]
  },
  {
    path: ['linear', 'create'],
    ...
    examples: [
      'h0x linear create --title "Investigate flaky login" --team ENG --project "Launch"',
      'h0x linear create --title "Follow-up bug" --parent-current --body-file - --json'
    ],
