...
export const PROJECT_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage: 'h0x project setups [--project <id>] [--host <host-id>] [--json]',
    ...
    examples: [
      'h0x project setups',
      'h0x project setups --project github:vjk7989/h0x-ade',
      'h0x project setups --host local',
      'h0x project setups --host runtime:03ef704c-b180-4b10-998d-e28fbd5de9a3'
    ]
  },
  {
    ...
    examples: [
      'h0x project setup-existing-folder --project github:vjk7989/h0x-ade --host local --path ~/h0x-ade',
      'h0x project setup-existing-folder --project github:vjk7989/h0x-ade --host runtime:03ef704c-b180-4b10-998d-e28fbd5de9a3 --path /home/me/h0x-ade --kind git --json'
    ]
  },
  {
    ...
    examples: [
      'h0x project setup-clone --project github:vjk7989/h0x-ade --host local --url https://github.com/vjk7989/h0x-ade.git --destination ~/src',
      'h0x project setup-clone --project github:vjk7989/h0x-ade --host runtime:03ef704c-b180-4b10-998d-e28fbd5de9a3 --url https://github.com/vjk7989/h0x-ade.git --destination /srv --json'
    ]
  },
  {
  ...
  },
  {
    ...
    examples: [
      'h0x project setup-update --setup github:vjk7989/h0x-ade::gpu --display-name "GPU VM"',
      'h0x project setup-update --setup github:vjk7989/h0x-ade::gpu --path /srv/h0x-ade --state ready --json'
    ]
  },
  {
    ...
    usage: 'h0x project setup-delete --setup <setup-id> [--json]',
    ...
    examples: ['h0x project setup-delete --setup github:vjk7989/h0x-ade::gpu --json']
  }
]
