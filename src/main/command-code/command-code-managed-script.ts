...
export function buildCommandCodeManagedScript(
  ...
  if (target === 'local' && process.platform === 'win32') {
    return [
      ...
      'if exist "%APPDATA%\\h0x-dev\\agent-hooks" for /r "%APPDATA%\\h0x-dev\\agent-hooks" %%F in (endpoint.cmd) do call :maybeSourceEndpoint "%%~fF"',
  ...
  return [
    ...
    '# still has h0x-ADE pane/hook metadata, so recover it before posting.',
    ...
    '  for endpoint in \\',
    '    "$HOME/Library/Application Support/h0x-dev/agent-hooks"/*/endpoint.env \\',
    '    "$HOME/Library/Application Support/h0x-dev/agent-hooks/endpoint.env" \\',
    '    "${XDG_CONFIG_HOME:-$HOME/.config}/h0x-dev/agent-hooks"/*/endpoint.env \\',
    '    "${XDG_CONFIG_HOME:-$HOME/.config}/h0x-dev/agent-hooks/endpoint.env" \\',
