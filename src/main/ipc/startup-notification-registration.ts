...
export function triggerStartupNotificationRegistration(store: Store): void {
  ...
  const notification = new Notification({
    title: `${PRODUCT_DISPLAY_NAME} is ready to notify you`,
    body: `Allow notifications so ${PRODUCT_DISPLAY_NAME} can alert you when agents finish or terminals need attention.`
  })
