  ...
  it.each([
    ...
    async (platform, manifestName) => {
      ...
      expect(manifestUrls).toEqual([
        `https://github.com/vjk7989/h0x-ade/releases/download/v1.4.1/${manifestName}`
      ])
      expect(assetUrls).toEqual([
        'https://github.com/vjk7989/h0x-ade/releases/download/v1.4.1/Orca-1.4.1-arm64-mac.zip'
      ])
