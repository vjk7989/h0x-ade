...
const ATOM_FEED_URL = 'https://github.com/vjk7989/h0x-ade/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/vjk7989/h0x-ade/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/vjk7989\/h0x-ade\/releases\/tag\/([^"]+)"/g
...
async function getReleaseAssetReadiness(tag: string, assetName: string): Promise<ReleaseReadiness> {
  ...
  const isGitHubReleaseAsset =
    ...
    (isRelativeAsset ||
      ...
      /^https:\/\/github\.com\/vjk7989\/h0x-ade\/releases\/download\//i.test(assetName))
