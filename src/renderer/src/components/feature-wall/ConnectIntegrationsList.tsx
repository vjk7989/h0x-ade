      ...
      <div className="space-y-2.5">
        <IntegrationStep
          ...
          description={translate(
            ...
            'Connect a review provider so h0x-ADE can show PR or MR status, checks, and reviews.'
          )}
          summary={
            <>
        ...
        <IntegrationStep
          ...
          description={translate(
            ...
            'Connect where your team tracks work. h0x-ADE starts workspaces with the issue title, link, and context already attached.'
          )}
          summary={
