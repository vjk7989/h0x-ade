...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when h0x-ADE Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove h0x-ADE Mobile')
  })

  it('labels the restore action explicitly when h0x-ADE Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
