  ...
  const title = visibleBusy
    ...
    : providerMissing
      ? translate(
          ...
          'h0x Relay isn’t available on this desktop.'
        )
      : reconnectRequired
        ? translate(
            'auto.components.mobile.MobileRelayMintFailureNotice.reconnectTitle',
            'Your h0x-ADE account session expired.'
          )
        : translate(
    ...
    : providerMissing
      ...
      : reconnectRequired
        ? translate(
            ...
            'Sign in again to use h0x Relay, or use LAN to pair over Tailscale or the same Wi‑Fi.'
          )
        : translate(
