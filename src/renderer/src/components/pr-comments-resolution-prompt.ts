...
export function buildPRCommentsResolutionPrompt({
  ...
  return [
    ...
    '- h0x-ADE acknowledges this feedback on the host itself after launch. Do not resolve or unresolve threads on the host, reply on the host, edit host comments, or use provider APIs/CLIs just to change review state.',
