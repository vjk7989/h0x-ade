...
> = {
  ...
  fork_head_unsupported: {
    ...
    body: {
      ...
      fallback: 'h0x-ADE cannot create a {{reviewLabel}} from this fork head here.'
    }
  },
  base_not_on_remote: {
    title: {
  ...
  unsupported_provider: {
    ...
    body: {
      ...
      fallback: 'This repository provider does not support creating a {{reviewLabel}} from h0x-ADE.'
    }
  }
}
  ...
  if (reason === 'existing_review') {
    ...
    return {
      ...
      description: translate(
        ...
        'h0x-ADE found an existing {{reviewLabel}} for this branch.',
        { reviewLabel }
      ),
      composerMode: 'hidden',
      workflowAction: null,
...
> = {
  ...
  auth_required: {
    ...
    body: {
      ...
      fallback:
        '{{provider}} must be connected in this environment before h0x-ADE can create a {{reviewLabel}}.'
    },
    workflow: null
  }
}
