...
function getInstallDescription(platform: string): string {
  if (platform === 'darwin') {
    return 'Register `h0x` in /usr/local/bin.'
  }
  if (platform === 'linux') {
    return 'Register `h0x` in ~/.local/bin.'
  }
  if (platform === 'win32') {
    return 'Register `h0x` in your user PATH.'
  }
    ...
    <section className="space-y-4" data-settings-section="cli">
      <div className="space-y-1">
        <h2 className="text-sm font-semibold">
          {translate('auto.components.settings.CliSection.c5c0f2641d', 'h0x CLI')}
        </h2>
        <p className="text-xs text-muted-foreground">
          {translate(
            'auto.components.settings.CliSection.6930feda9e',
            'Use h0x from your terminal to open the app, manage worktrees, and interact with h0x-ADE terminals.'
          )}
        </p>
      </div>
          ...
          <div className="border-t border-border/60 pt-3">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                {translate(
                  ...
                  'Give agents h0x-ADE-aware workspace, terminal, and progress workflows.'
                )}
              </p>
            </div>
            ...
            <AgentSkillSetupPanel
              ...
              description={translate(
                ...
                'Enables agents to use h0x-ADE workspace, terminal, and progress commands.'
              )}
