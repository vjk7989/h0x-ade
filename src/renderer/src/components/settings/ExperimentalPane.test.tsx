...
describe('ExperimentalPane', () => {
  ...
  it('shows the structured-native-chat child setting only when Chat UI is the default view', async () => {
    ...
    expect(container.textContent).toContain(
      'Local sessions only for now. WSL and remote execution hosts (including SSH) continue to use terminal chat, and Windows falls back to it unless h0x-ADE can read process start times.'
    )
