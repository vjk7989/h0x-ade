...
const ORCA_ANDROID_APK_URL =
  'https://github.com/vjk7989/h0x-ade/releases/download/mobile-android-v0.0.47/app-release.apk'
    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <p>
            {translate(
              ...
              'Install h0x-ADE Mobile from the'
            )}{' '}
            <button
              type="button"
      ...
      <SearchableSetting
        title={translate(
          ...
          'Show h0x-ADE Mobile Button'
        )}
        description={translate(
          'auto.components.settings.MobileSettingsPane.682293cadf',
          'Show the h0x-ADE Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the h0x-ADE Mobile shortcut in the sidebar.'
          )}
