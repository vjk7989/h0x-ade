...
export function CodeHostSetupSteps(
  ...
  const connectionDescription = props.unavailable
    ? translate(
        ...
        "h0x-ADE couldn't check this connection. Try again, or open Integrations for setup details."
      )
    : translate(
        'auto.components.settings.TasksPane.connectCodeHostDescription',
        'Install and authenticate the CLI under Integrations so h0x-ADE can load issues.'
      )
