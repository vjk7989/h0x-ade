 ...
 * updates replace the bundle), Accessibility/Automation grants on h0x-ADE silently stop
        ...
        <div className="min-w-0 space-y-1">
          ...
          <p className="text-xs leading-snug">
            {translate(
              ...
              'The terminal daemon was started by an h0x-ADE install that no longer exists, so macOS can’t attribute its commands to h0x-ADE — Accessibility and Automation grants are silently ignored (osascript fails with error -25211). Restarting the daemon fixes this; running terminal sessions will close.'
            )}
          </p>
        </div>
      </div>
