    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'Configured via environment variables. Unset the ORCA_BITBUCKET_* variables to manage this credential in h0x-ADE.'
        )}
      </p>
    )
  }
      ...
      <p className="text-xs text-muted-foreground">
        {props.storedCredential
          ...
          : translate(
              ...
              'Bitbucket credentials are configured but could not authenticate. Check the token and repository permissions, then restart h0x-ADE if environment variables changed.'
            )}
      </p>
    )
  }
    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'Saved in h0x-ADE on this machine. ORCA_BITBUCKET_* environment variables take precedence when set.'
        )}
      </p>
    )
  }
