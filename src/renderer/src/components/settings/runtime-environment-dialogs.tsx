        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {translate(
              ...
              'h0x-ADE will focus this host and load its projects. Existing terminals and browser tabs on other hosts stay alive.'
            )}
          </DialogDescription>
        </DialogHeader>
        {pendingSwitchValue ? (
          ...
          <DialogDescription>
            {removingActiveServer
              ...
              : translate(
                  ...
                  'This removes the saved server from h0x-ADE. It does not change the active server.'
                )}
          </DialogDescription>
        </DialogHeader>
        {pendingRemove ? (
