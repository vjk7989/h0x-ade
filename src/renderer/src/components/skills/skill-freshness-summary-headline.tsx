    ...
    return (
      <div className="flex items-center gap-2 text-xs text-muted-foreground">
        ...
        {translate(
          ...
          'Checking installed h0x-ADE skills…'
        )}
      </div>
    )
  }
    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'No installed h0x-ADE skills found.'
        )}
      </p>
    )
  }
    ...
    return (
      <div className="flex items-center gap-2 text-sm font-medium text-foreground">
        ...
        {translate(
          ...
          'All installed h0x-ADE skills are up to date.'
        )}
      </div>
    )
  }
    ...
    return (
      <div className="flex items-center gap-2 text-sm font-medium text-foreground">
        ...
        {translate(
          ...
          'Some installed h0x-ADE skills were left out of the update.'
        )}
      </div>
    )
  }
