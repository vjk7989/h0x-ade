...
export function skillInstallManagementCopy() {
  return {
    title: translate(
      ...
      'Installed by h0x-ADE'
    ),
    description: translate(
      'auto.components.skills.SkillInstallManagementDialog.3677ae58e7',
      'Skills h0x-ADE installed from a link. Reinstall, go back to an earlier version, or remove them.'
    ),
    ...
    noInstalls: translate(
      ...
      'h0x-ADE has not installed any skills on this machine yet.'
    ),
