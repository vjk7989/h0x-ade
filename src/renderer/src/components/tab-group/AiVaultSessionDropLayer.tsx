      ...
      void preparation
        .then((result) => {
          ...
          if (!startup) {
            ...
            throw new Error(
              result.substituteCodexHome
                ? 'This session was dragged from an older h0x-ADE window, so h0x-ADE cannot retarget it to the selected Codex account. Resume it from the Session History panel instead.'
                : 'h0x-ADE could not prepare this legacy Codex session. Retry resume.'
            )
          }
