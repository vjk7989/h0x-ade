  ...
  return [
      ...
      : []),
    {
      ...
      title: translate(
        ...
        'Remote h0x-ADE Servers'
      ),
      description: isWebClient
        ? 'Connect this browser to a saved h0x-ADE server.'
        : 'Pair remote h0x-ADE runtimes for persistent sessions, richer remote state, and web or mobile handoff.',
      icon: Server,
    ...
    // multiple hosts (local + a Remote h0x-ADE Server, or two clones) collapses to
