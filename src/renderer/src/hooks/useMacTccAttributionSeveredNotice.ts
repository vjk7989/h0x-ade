      ...
      try {
        ...
        toast.warning(
          translate(
            ...
            'macOS permissions may not reach h0x-ADE terminals'
          ),
          {
            id: SEVERED_TCC_NOTICE_ID,
            description: translate(
              'auto.hooks.useMacTccAttributionSeveredNotice.description',
              'Running h0x-ADE terminals are hosted by a daemon started by a previous h0x-ADE installation. macOS may not apply h0x-ADE’s Accessibility, Automation, or protected-file permissions to them. Restart the daemon from Manage Sessions to restore access. This will close all running h0x-ADE terminals.'
            ),
            duration: Infinity,
            action: {
              label: translate(
