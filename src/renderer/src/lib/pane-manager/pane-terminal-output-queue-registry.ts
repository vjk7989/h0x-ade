...
export const BACKGROUND_BACKLOG_WARNING =
  '\x18\x1b[0m\r\n[h0x-ADE skipped hidden terminal output because the backlog grew too large.]\r\n'
...
export const FOREGROUND_BACKLOG_WARNING =
  '\x18\x1b[0m\r\n[h0x-ADE skipped a burst of terminal output because the backlog grew too large.]\r\n'
