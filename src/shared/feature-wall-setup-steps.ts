...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use h0x-ADE's browser",
    subtitle: "Use h0x-ADE's browser",
    description:
      'Browse your web app without leaving h0x-ADE. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable h0x CLI',
    subtitle: 'Enable h0x CLI',
    description:
      'Register the h0x-ADE shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into h0x-ADE so you can start agent work without hunting for folders.'
  }
] as const
