...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  ...
  },
  {
    ...
    caption:
      'Run agents on a remote machine with the same h0x-ADE editing, git, and terminal workflow.',
    gifPath: 'tile-06.gif',
  ...
  },
  {
    ...
    kind: 'media',
    title: 'h0x CLI',
    caption: 'Agents can drive h0x-ADE too: create workspaces, snapshot screens, click, and fill.',
    gifPath: 'tile-09.gif',
