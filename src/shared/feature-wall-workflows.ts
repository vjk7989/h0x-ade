...
export const FEATURE_WALL_WORKFLOWS: readonly FeatureWallWorkflow[] = [
  {
    ...
    lede: 'h0x-ADE splits each task into an isolated workspace so agents can run in parallel.',
  ...
  },
  {
    ...
    title: 'Agents',
    meta: 'Agents · Usage · h0x CLI',
    lede: 'Run several agents at once, track their progress, and let automation drive h0x-ADE when it helps.',
  ...
  },
  {
    ...
    lede: 'Bring your terminal setup into h0x-ADE, then split panes to keep servers, tests, logs, and agents running side by side.',
