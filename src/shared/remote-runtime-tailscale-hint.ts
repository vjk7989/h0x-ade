...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote (?:h0x-ade|orca) runtime|remote (?:h0x-ade|orca) runtime closed the connection|timed out (?:waiting for|while connecting to) the remote (?:h0x-ade|orca) runtime/i
