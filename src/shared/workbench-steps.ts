// Per-step copy for the workbench tile in the Explore h0x-ADE modal. Mirrors
...
export const WORKBENCH_STEPS: readonly WorkbenchStep[] = [
  ...
  },
  {
    ...
    name: 'Editor',
    subtitle: 'Editor',
    description: 'Use our Notion-style markdown editor to write notes without leaving h0x-ADE.'
  },
  {
    id: 'browser',
    name: 'Browser',
